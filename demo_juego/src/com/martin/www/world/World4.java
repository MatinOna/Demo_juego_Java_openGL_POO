 ...
 * @author Martin
 */
public class World4 extends Object implements Displayable{
    ...
    public static ArrayList<Colisionable> graphic4;
    

    

    public World4(float x, float y, float z, float width, float height, float depth, float rotx, float roty, float rotz, GL gl) {
        ...
        graphic4=new ArrayList<Colisionable> ();
        ...
        for(int i=33;i>=-33;i-=4){
                //pinos grnades
//                graphic4.add(new PineTree(     -33.0f,2.0f,i,       0.8f, 1f,0.8f,                  0.0f, 0.0f, 0.0f, gl));
//                graphic4.add(new PineTree(     -33.0f,2.0f,i,       0.8f, 1f,0.8f,                  0.0f, 45.0f, 0.0f, gl));
                
//                graphic4.add(new PineTree(     33.0f,2.0f,i,       0.8f, 1f,0.8f,                  0.0f, 0.0f, 0.0f, gl));
//                graphic4.add(new PineTree(     33.0f,2.0f,i,       0.8f, 1f,0.8f,                  0.0f, 45.0f, 0.0f, gl));
//                
//                graphic4.add(new PineTree(     i,2.0f,-33,       0.8f, 1f,0.8f,                  0.0f, 90.0f, 0.0f, gl));
//                graphic4.add(new PineTree(     i,2.0f,-33,       0.8f, 1f,0.8f,                  0.0f, 45.0f, 0.0f, gl));
        ...
        {
                graphic4.add(new Tree(     -27f,2.0f,i,       0.8f, 0.8f,0.8f,                  0.0f, 90.0f, 0.0f, gl));
                graphic4.add(new Tree(     -27f,2.0f,i,       0.8f, 0.8f,0.8f,                  0.0f, 0.0f, 0.0f, gl));
...
//                graphic.add(new Tree(     i,2.0f,-27f,       0.8f, 0.8f,0.8f,                  0.0f, 90.0f, 0.0f, gl));
                ...
                graphic4.add(new Tree(     i,2.0f,27f,       0.8f, 0.8f,0.8f,                  0.0f, 90.0f, 0.0f, gl));
                graphic4.add(new Tree(     i,2.0f,27f,       0.8f, 0.8f,0.8f,                  0.0f, 00.0f, 0.0f, gl));
                
        }
        graphic4.add(new Tree(    10 ,2.0f,0f,       0.4f, 0.4f,0.4f,                  0.0f, 00.0f, 0.0f, gl));
        graphic4.add(new Tree(    10 ,2.0f,0f,       0.4f, 0.4f,0.4f,                  0.0f, 90.0f, 0.0f, gl));
        
        graphic4.add(new Tree(    -10 ,2.0f,0f,       0.4f, 0.4f,0.4f,                  0.0f, 00.0f, 0.0f, gl));
        graphic4.add(new Tree(    -10 ,2.0f,0f,       0.4f, 0.4f,0.4f,                  0.0f, 90.0f, 0.0f, gl));
         
        graphic4.add(new Tree(    10 ,2.0f,15f,       0.4f, 0.4f,0.4f,                  0.0f, 00.0f, 0.0f, gl));
        graphic4.add(new Tree(    10 ,2.0f,15f,       0.4f, 0.4f,0.4f,                  0.0f, 90.0f, 0.0f, gl));
        ...
        {
            graphic4.add(new House(-22,3f,i,       1.5f,1.0f,1.5f,               0,90,0,           gl));   
            graphic4.add(new House(22,3f,i,       1.5f,1.0f,1.5f,               0,-90,0,           gl));   
        ...
        for(int i=-20;i<=22;i+=8)
        {
            ...
            graphic4.add(new Car(17,2.0f,i,    0.8f,0.8f,0.8f,               0,-90,0,           gl));
            graphic4.add(new Car(-17,2.0f,i,  0.8f,0.8f,0.8f,            0,90,0,           gl));
        }
        for(int j=27;j>=8;j-=8)
        {
            graphic4.add(new Tree(     j,2.0f,-27f,       0.8f, 0.8f,0.8f,                  0.0f, 00.0f, 0.0f, gl));
            graphic4.add(new Tree(     j,2.0f,-27f,       0.8f, 0.8f,0.8f,                  0.0f, 90.0f, 0.0f, gl));
            
            graphic4.add(new Tree(     -j,2.0f,-27f,       0.8f, 0.8f,0.8f,                  0.0f, 00.0f, 0.0f, gl));
            graphic4.add(new Tree(     -j,2.0f,-27f,       0.8f, 0.8f,0.8f,                  0.0f, 90.0f, 0.0f, gl));
        }
        
//        graphic4.add(new Woman(10,3.0f,-5,    0.4f,0.4f,0.4f,               0,0,0,           gl));   
//        graphic4.add(new Man(8.5f,3.0f,-5,    0.4f,0.5f,0.4f,               0,0,0,           gl));
//        graphic4.add(new Woman(-6,3.0f,0,    0.4f,0.4f,0.4f,               0,0,0,           gl));   
//        graphic4.add(new Man(-7.5f,3.0f,0,    0.4f,0.5f,0.4f,               0,0,0,           gl));
//        graphic4.add(new Woman(-9,3.0f,20,    0.4f,0.4f,0.4f,               0,0,0,           gl));   
//        graphic4.add(new Man(-7.5f,3.0f,20,    0.4f,0.5f,0.4f,               0,0,0,           gl));
//        graphic4.add(new Woman(11,3.0f,20,    0.4f,0.4f,0.4f,               0,0,0,           gl));   
//        graphic4.add(new Man(-12.5f,3.0f,-12,    0.4f,0.5f,0.4f,               0,0,0,           gl));
//        graphic4.add(new Woman(-9,3.0f,13,    0.4f,0.4f,0.4f,               0,0,0,           gl));   
        graphic4.add(new Cloud(1.0f,15f,5f,   0.7f,0.5f,0.5f,   0,0,0,gl));
        graphic4.add(new Cloud(-20.0f,15f,10f,   0.7f,0.5f,0.5f,   0,0,0,gl));
        graphic4.add(new Cloud(30.0f,20f,-20f,   0.7f,0.5f,0.5f,   0,0,0,gl));
        graphic4.add(new Cloud(-30.0f,25f,-20f,   0.7f,0.5f,0.5f,   0,0,0,gl));
        graphic4.add(new Cloud(-25.0f,15f,-30f,   0.7f,0.5f,0.5f,   0,0,0,gl));
        graphic4.add(new Cloud(25.0f,15f,12f,   0.7f,0.5f,0.5f,   0,0,0,gl));
        graphic4.add(new Cloud(25.0f,15f,-25f,   0.7f,0.5f,0.5f,   0,0,0,gl));
...
//        }              
    ...
    gl.glPushMatrix();
       ...
       for(Colisionable objetos : graphic4) {
