 ...
 * @author Martin
 */
public class World1 extends Object implements Displayable{
    
    public Cube bloque,bloque1,bloque2,bloque3,bloque31,bloque4,calle,linea1,linea2,linea3;
    
    
    public Man hombre;  private float inchombre=0.05f;
    ...
    public World1(float x, float y, float z, float width, float height, float depth, float rotx, float roty, float rotz, final GL gl) {
...
//                graphic.add(new PineTree(     33.0f,2.0f,i,       0.8f, 1f,0.8f,                  0.0f, 0.0f, 0.0f,2 gl));
//                graphic.add(new PineTree(     33.0f,2.0f,i,       0.8f, 1f,0.8f,                  0.0f, 45.0f, 0.0f, gl));
