 ...
 * @author Martin
 */
public class World2 extends Object implements Displayable{
    ...
    public World2(float x, float y, float z, float width, float height, float depth, float rotx, float roty, float rotz, GL gl) {
