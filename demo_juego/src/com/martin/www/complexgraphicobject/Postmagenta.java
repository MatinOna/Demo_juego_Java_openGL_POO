 ...
 * @author Martin
 */
public class Postmagenta extends Object implements Displayable,Colisionable{
    
    
    public Cube cubo,cuerpo ;
    public Icosahedron foco;

    public Postmagenta(float x, float y, float z, float width, float height, float depth, float rotx, float roty, float rotz, GL gl) {
    ...
    gl.glPushMatrix();
       ...
       cubo.display();
       cuerpo.display();
       Ona_Jativa_Proyecto.materiales.get("fmagenta").activar();
       foco.display();
