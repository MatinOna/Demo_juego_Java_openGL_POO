 ...
 * @author Martin
 */
public class Woman extends Object implements Displayable,Colisionable{
    ...
    public Woman(float x, float y, float z, float width, float height, float depth, float rotx, float roty, float rotz, GL gl) {
        super(x, y, z, width, height, depth, rotx, roty, rotz, gl);
        
        bloque=new Cube(0,0,0  ,1,1,0.5f  ,0,0,0,gl,     0.243f , 0.054f , 0.250f, Ona_Jativa_Proyecto.texturas.get("wool_colored_magenta"));
    ...
    gl.glPushMatrix();
       ...
       Ona_Jativa_Proyecto.materiales.get("twoman").activar();
       bloque.display();
       Ona_Jativa_Proyecto.materiales.get("ttwoman").activar();
